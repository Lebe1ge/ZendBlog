...
--
-- Client :  127.0.0.1
-- Généré le :  Ven 19 Février 2016 à 17:21
...
--
ALTER TABLE `tag`
 ADD PRIMARY KEY (`tag_id`), ADD UNIQUE KEY `UNIQ_389B783989D9B62` (`slug`), ADD UNIQUE KEY `UNIQ_389B7835E237E06` (`name`);
